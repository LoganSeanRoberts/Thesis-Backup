...
\begin{figure}
    \centering
    \includegraphics[width=0.75\linewidth]{chapter4/pdfs/CustomAmps.pdf}
...
\begin{figure}
    \centering
    \includegraphics[width=0.9\linewidth]{chapter4/pdfs/0tw.pdf}
    \includegraphics[width=0.9\linewidth]{chapter4/pdfs/2tw.pdf}
    \caption{Caption}
